    ...
    def text_generator(self, example_generator):
        ...
        while True:
            ...
            try:
                ...
                article_pos_text = e.features.feature['article_pos'].bytes_list.value[
                    0]  # the article text was saved under the key 'article_pos' in the data files
                article_ner_text = e.features.feature['article_ner'].bytes_list.value[
                    0]  # the article text was saved under the key 'article_ner' in the data files
